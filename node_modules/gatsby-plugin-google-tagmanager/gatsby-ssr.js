...
var generateGTM = function generateGTM(_ref) {
  ...
  return (0, _commonTags.stripIndent)(_templateObject(), environmentParamStr, id);
};
...
var generateDefaultDataLayer = function generateDefaultDataLayer(dataLayer, reporter) {
  var result = "window.dataLayer = window.dataLayer || [];";
...
exports.onRenderBody = function (_ref3, _ref4) {
  ...
  if (process.env.NODE_ENV === "production" || includeInDevelopment) {
    ...
    if (defaultDataLayer) {
      defaultDataLayerCode = generateDefaultDataLayer(defaultDataLayer, reporter);
    }
