...
const Craft = ({
  ...
  <section className='is-light-blue-er is-paddingless is-marginless' style={{ position: 'relative' }}>
    <div className='is-light-blue-er' style={{ height: '700px', width: '145vw', border: 'solid transparent 5px', borderTopLeftRadius: '50%', borderTopRightRadius: '50%', transform: 'translate(-500px, -100px)', overflow: 'hidden', zIndex: 10 }}>
      <div ><p> </p></div>
    </div>
